    ...
    <div class="container" style="width: 90%;">
        ...
        <form action="<?php echo site_url('create-invoice-and-download'); ?>" method="post" id="invoice-create-form" enctype="multipart/form-data">
            ...
            <div class="">
                ...
                <input type="text" value="<?php echo $unique_code = uniqid(); ?>" name="invoice_code" id="invoice_code" readonly>
            </div>
            ...
            <div id="invoice-items">
                ...
                <div class="invoice-item row">
                    ...
                    <div style="padding: 1% 0.5%;" class="invoice-field col l3 m12 s12">
                        ...
                        <input type="text" name="total-prod-cost[]"  item-pos="0" class="total-prod-costs" id="total-prod-cost-0" value="<?php $totalProdCost=0.00; $totalProdCost= $first_uni_item['prod_cost']+($first_uni_item['cloth_reqd']*50); echo $totalProdCost+=(0.25*$totalProdCost); ?>" readonly>                
                    </div>
